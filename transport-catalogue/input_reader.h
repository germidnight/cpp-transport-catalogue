 ...
 * 1) Stop X: latitude, longitude, D1m to stop1, D2m to stop2, ... - Добавляет информацию об остановке с названием X
 * и координатами latitude (широта) и longitude (долгота) на земной поверхности,
 *
 * после широты и долготы содержится список расстояний (целое положительное число) от этой остановки до соседних с ней остановок.
 * Расстояния задаются в метрах. Предполагается, что расстояние от остановки X до остановки stop# равно расстоянию от stop# до X,
